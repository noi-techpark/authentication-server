                ...
                <#if displayMessage && message?has_content && (message.type !='warning' || !isAppInitiatedAction??)>
                    <div class="alert-${message.type} ${properties.kcAlertClass!}">
                        <div class="mr-4 self-center">
                            <#if message.type='success'><svg xmlns="http://www.w3.org/2000/svg" height="24"
                                    viewBox="0 0 24 24" width="24" fill="currentColor">
                                    <path d="M0 0h24v24H0z" fill="none" />
                                    <path
                                        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                                </svg></#if>
                            <#if message.type='warning'><svg xmlns="http://www.w3.org/2000/svg" height="24"
                                    viewBox="0 0 24 24" width="24" fill="currentColor">
                                    <path d="M0 0h24v24H0z" fill="none" />
                                    <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z" />
                                </svg></#if>
                            <#if message.type='error'><svg xmlns="http://www.w3.org/2000/svg" height="24"
                                    viewBox="0 0 24 24" width="24" fill="currentColor">
                                    <path d="M0 0h24v24H0z" fill="none" />
                                    <path
                                        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" />
                                </svg></#if>
                            <#if message.type='info'><svg xmlns="http://www.w3.org/2000/svg" height="24"
                                    viewBox="0 0 24 24" width="24" fill="currentColor">
                                    <path d="M0 0h24v24H0z" fill="none" />
                                    <path
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <nav role="navigation" class="mb-2 mx-2 xs:mx-4 flex lg:hidden flex-col items-stretch">
                                <#if realm.internationalizationEnabled && locale.supported?size gt 1>
                                    <div class="group relative block">
                                        <button
                                            class="relative w-full pl-4 pr-4 py-2 text-left uppercase mobile-language-select-button"
                                            onclick="toggleLanguage()">
                                            <div class="block pr-6">
                                                ${locale.current}
                                            </div>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="18"
                                                class="absolute vertical-center fill-current" style="right: 1rem">
                                                <path
                                        ...
                                        <ul id="mobile-languages" class="mobile-languages">
                                            <#list locale.supported as l>
                                                <li><a href="${l.url}"
                                                        class="block px-4 py-2 hover:bg-black hover:text-white">${l.label}</a>
                                                </li>
                                            </#list>
                                        </ul>
                                    </div>
